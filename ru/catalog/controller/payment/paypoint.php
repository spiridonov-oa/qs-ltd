...
class ControllerPaymentPaypoint extends Controller {
	...
	public function callback() {
		...
		if ($order_info) {
			...
			$this->data['text_failure_wait'] = sprintf($this->language->get('text_failure_wait'), $this->url->link('module/personal_cart'));
			...
			if (isset($this->request->get['code']) && $this->request->get['code'] == 'A' && $status) {
				...
				$this->data['continue'] = $this->url->link('module/personal_cart');
