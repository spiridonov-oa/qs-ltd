...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="content">
    <p>
      <?php if ($search) { ?>
      <input type="text" name="search" placeholder="<?php echo $entry_search; ?>" value="<?php echo $search; ?>" />
      <?php } else { ?>
      <input type="text" name="search" placeholder="<?php echo $entry_search; ?>" value="<?php echo $search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '000000'" style="color: #999;" />
      <?php } ?>
  ...
  <div class="buttons ">
    <div class="left"><button id="button-search" class="button green"><?php echo $button_search; ?></button></div>
  </div>
  ...
  <div class="box-product product-list list-layout">
    ...
    <div>
      ...
      <?php } ?>
      <div class="cart"><a onclick="addToCart(<?php echo $product['product_id']; ?>);" class="btn-cart"><span><?php echo $button_cart; ?></span></a></div>
...
$('select[name=\'category_id\']').bind('change', function() {
	if (this.value == '0') {
		...
		$('input[name=\'sub_category\']').prop( "checked", true );
	} else {
