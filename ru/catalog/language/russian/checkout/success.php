...
// Text
$_['text_customer'] = '<p>Ваш заказ успешно создан!</p><p>Вы можете просматривать историю заказов в <a href="%s">Личном кабинете</a>, открыв <a href="%s">Историю заказов</a>.<p>По всем вопросам Вы можете связаться с нами перейдя на страницу <a href="%s">Контакты</a></p><p>Спасибо за покупки в нашем интернет-магазине!</p>';
