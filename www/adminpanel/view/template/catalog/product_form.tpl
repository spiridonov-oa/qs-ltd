      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea cols="100" rows="10" name="product_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_tag; ?></td>
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" size="100" /></td>
              </tr>
            </table>
          </div>
          <?php } ?>
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="right"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][weight_prefix]">
                    ...
                    <input type="hidden" name="link-name"  class="link-name" size="50"/><input type="hidden" class="product-option-link" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][link]" value="<?php echo $product_option_value['link']; ?>"  size="50" />
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
                ...
                <tr>
                    ...
                    <td class="left" style="width: 500px;"><input type="text" name="link-name"  class="link-name" value="<?php echo $product_option_value['link_name']; ?>" size="50"/>
                          <input class="product-option-link" type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][link]" value="<?php echo $product_option_value['link']; ?>" size="5" /></td>
                    <td class="left"><a onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
                </tr>
                </tbody>
                <?php $option_value_row++; ?>
                ...
                <tr>
                    <td colspan="3"></td>
                    <td class="left"><a onclick="addLinkOptionValue('<?php echo $option_row; ?>');" class="button"><?php echo $button_add_option_value; ?></a></td>
                </tr>
                </tfoot>
            </table>
        ...
        <div id="tab-video">
            <table id="videos" class="list">
                ...
                <tr>
                    <td class="left"><?php echo $entry_image; ?></td>
                    <td class="left"><?php echo 'Video Link'; ?></td>
                    <td class="right"><?php echo $entry_sort_order; ?></td>
                    <td></td>
                </tr>
                </thead>
                ...
                <tr>
                    <td class="left"><div class="image"><img src="<?php echo $product_video['thumb']; ?>" alt="" id="thumb_video<?php echo $video_row; ?>" />
                        <input type="hidden" name="product_video[<?php echo $video_row; ?>][image]" value="<?php echo $product_video['image']; ?>" id="video_image<?php echo $video_row; ?>" />
                        <br />
                        <a onclick="image_upload('video_image<?php echo $video_row; ?>', 'thumb_video<?php echo $video_row; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb_video<?php echo $video_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#video_image<?php echo $video_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
                    <td class="left"><input type="text" name="product_video[<?php echo $video_row; ?>][video]" value="<?php echo $product_video['video']; ?>" size="30" /></td>
...
function autocompleteLink () {
    $('.link-name').autocomplete({
        ...
        select: function(event, ui) {
            $(this).next('.product-option-link').val(ui.item.value);
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		html += '	      <option selected value="0"><?php echo $text_no; ?></option>';
		html += '	    </select></td>';
		html += '     </tr>';
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
            ...
            for (var i = 0; i < ui.item.option_value.length; i++) {
        ...
        if (ui.item.type == 'link') {
            ...
            html += '        <td class="left"><a onclick="addLinkOptionValue(' + option_row + ');" class="button"><?php echo $button_add_option_value; ?></a></td>';
            html += '      </tr>';
            html += '    </tfoot>';
            html += '  </table>';
            html += '  <select id="option-values' + option_row + '" style="display: none;">';
...
function addOptionValue(option_row) {	
	...
	html += '      <option value="-">-</option>';
	html += '    </select>';
    html += '    <input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][link]" value=""  size="50" />';
...
function addLinkOptionValue(option_row) {
    html  = '<tbody id="option-value-row' + option_value_row + '">';
    html += '  <tr>';
    html += '    <td class="left"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value_id]">';
    html += $('#option-values' + option_row).html();
    html += '    </select><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][product_option_value_id]" value="" /></td>';
    html += '    <td><div style="display: none"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][quantity]" value="" size="3" />';
    html += '    <select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][subtract]">';
    html += '      <option value="0"><?php echo $text_no; ?></option>';
    html += '    </select>';
    ...
    html += '      <option value="-">-</option>';
    html += '    </select>';
    html += '    <input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][weight]" value="" size="5" /></div></td>';
    html += '    <td class="left" style="width: 500px;"><input type="text" name="link-name[' + option_row + ']"  class="link-name" value="<?php echo $link_name; ?>" size="50"/><input type="hidden" class="product-option-link" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][link]" value="" size="5"/></td>';
    html += '    <td class="left"><a onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';
    html += '</tbody>';
...
function addVideo() {
    ...
    html += '  <tr>';
    html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb_video' + video_row + '" /><input type="hidden" name="product_video[' + video_row + '][image]" value="" id="video_image' + video_row + '" /><br /><a onclick="image_upload(\'video_image' + video_row + '\', \'thumb_video' + video_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb_video' + video_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#video_image' + video_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
    html += '    <td class="left"><input type="text" name="product_video[' + video_row + '][video]" value="" size="30" /></td>';
