<div class="toolbar">
	<ul>
		...
		<li style="float:right"><a href="mailto:ecomteck@gmail.com" class="support"><span class="icon-support"></span><span><?php echo $this->language->get("text_ecslideshow_support"); ?></span></a></li>
	</ul>
</div>